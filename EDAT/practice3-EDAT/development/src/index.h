...
int index_put_string(index_t *idx, char* string, long pos);
/* 
...
/*
  Function: type_t index_get_type(index_t* idx);

  Function that returns the type of the index INT or STR
   ...
   INT/STR: the type of the index
   -1: the index is not initialized
