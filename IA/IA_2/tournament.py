...
class Tournament(object):
  ...
  def __single_run(self, player1_first: bool, pl1: Player, name1: str, pl2: Player, name2: str, scores: dict, totals: dict):
        ...
        #scores[name1][name2] = score1 if name2 not in scores[name1] else score1 + scores[name1][name2]
        #scores[name2][name1] = score2 if name1 not in scores[name2] else score2 + scores[name2][name1]
