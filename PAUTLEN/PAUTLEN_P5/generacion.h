...
/*
    ...
    programa principal como puede gesasionarse el número de etiquetas cuantos_no.
*/
...
/*
   Si el destino de una lectura es una variable local o un parámetro, necesitamos
   usar leer_local, cuyo destino será la última variable (o posición) en la pila
*/
/* SALTOS */
...
/*
- Función que funciona igual que asignarDestinoEnPila pero recibe la direccion y el contenido a la inversa en pila
- Se debe asumir que en la pila estará
  * Primero (se ha introducido en la pila antes) lo que hay que asignar
  * Debajo (en la cima) la dirección donde hay que asignar
  * es_variable 
    - Es 1 si la expresión que se va a asignar es algo asimilable a una variable (identificador, o elemento de vector)
    - Es 0 en caso contrario (constante u otro tipo de expresión)
*/
