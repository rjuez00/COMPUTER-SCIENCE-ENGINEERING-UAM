...
Status SymbolTable_to_local(SymbolTable* table, char* namefunction, int value, short type, short category){
    ...
    returnValue = HashTable_insert(table->local, namefunction, value, FUNCTION, type, category);
    returnValue &= HashTable_insert(table->global, namefunction, value, FUNCTION, type, category);
