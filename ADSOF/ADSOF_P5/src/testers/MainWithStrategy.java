...
import rules.*;
import rules.strategies.Sequence;

public class MainWithStrategy {
	public static void main(String...args) throws ParseException{
		SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
		RuleSetWithStrategy<Product> rs = new RuleSetWithStrategy<Product>(new Sequence<>()); // A set of rules applicable to Products
		rs.add(
